...
class PostDao(object):
    ...
    def save(self, post):
        ...
        param.append(unicode_normalize(post.title))
...
#        query = "INSERT INTO post (id, type, postTime, title, anonymous, tagAgree, tagTop, tagTopTime, tagSolve, tagLector, countBrowse, countReply, countVote, lastReplyTime, lastReplyerId, posterId, relateUnit, unreadCount, content, lectorOrAssistFlag, hasVoteUp, deleted, shortIntroduction, pictures, postSource, courseId, courseProductType, courseMode, courseChannel, termId, startTime, endTime, closeVisableStatus, termPrice, forumId, schoolSN) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);"
        query = "INSERT INTO post (id, type, postTime, title, anonymous, tagAgree, tagTop, tagTopTime, tagSolve, tagLector, countBrowse, countReply, countVote, lastReplyTime, lastReplyerId, posterId, relateUnit, unreadCount, content, lectorOrAssistFlag, hasVoteUp, deleted, shortIntroduction, pictures, postSource, courseId, courseProductType, courseMode, courseChannel, termId, startTime, endTime, closeVisableStatus, termPrice, forumId, schoolSN) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s);"
